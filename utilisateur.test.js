...
describe("creation utilisateur", () => {
  ...
  it("insertion dun utilisateur réussie mais un champ nest pas défini", async () => {
    const utilisateuravecchampinvalide = new UtilisateurModel({
      nom: "Dylan",
      prenom: "Bob",
      mail: "test@demo.fr",
      mot_de_passe: "testtest",
    ...
    const sauvegardeutilisateuravecchampinvalide =
      await utilisateuravecchampinvalide.save();
  ...
  it("création dun utilisateur avec un champ non défini mais obligatoire", async () => {
    const utilisateuravecchampnondefinimaisobligatoire = new UtilisateurModel({
      nom: "Dylan",
      prenom: "Bob",
      mot_de_passe: "testtest",
      pseudo: "bobo",
    ...
    let err;
    try {
      const sauvegardeutilisateuravecchampnondefinimaisobligatoire =
        await utilisateuravecchampnondefinimaisobligatoire.save();
