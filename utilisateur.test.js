...
const userData = { nom: 'Dylan', prenom: 'Bob', pseudo: "bobo", mail: 'boby7@demo.fr', mot_de_passe: 'test', description: 'bla' };
describe('creation utilisateur', () => {
    ...
    it('insertion dun utilisateur réussie mais un champ nest pas défini', async () => {
        const utilisateuravecchampinvalide = new UtilisateurModel({nom: 'Dylan', prenom: 'Bob', mail: 'test@demo.fr', mot_de_passe: 'test',  pseudo: "bobo",  });
    ...
    it('création dun utilisateur avec un champ non défini mais obligatoire', async () => {
        const utilisateuravecchampnondefinimaisobligatoire = new UtilisateurModel({nom: 'Dylan', prenom: 'Bob', mot_de_passe: 'test',  pseudo: "bobo"});
        let err;
        try {
